...
import { ShoppingBag, Mail, Lock, ArrowRight, Store, Truck, ShieldAlert, Eye, EyeOff } from 'lucide-react';
...
export const BuyerLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-900/90 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-[0_0_50px_rgba(6,182,212,0.15)] backdrop-blur-xl text-white">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                required
                className="w-full pl-9 pr-10 py-3 bg-slate-950 border border-slate-800 rounded-xl text-sm font-medium focus:ring-2 focus:ring-cyan-500 text-white outline-hidden transition-all"
              />
              <button
                type="button"
