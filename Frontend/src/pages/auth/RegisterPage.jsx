          ...
          <div className="lg:col-span-7 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-slate-950 via-slate-900/90 to-emerald-950/30 text-white flex flex-col justify-center relative">
            ...
            <div className="mb-4 pb-3 border-b border-slate-800/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <Link
                  to="/seller/login"
                  className="px-3.5 py-1.5 rounded-full bg-slate-950 hover:bg-slate-800 border border-slate-700/80 text-emerald-400 text-xs font-extrabold flex items-center gap-1.5 shadow-md transition-all hover:scale-105"
                >
                ...
                <Link
                  to="/buyer/login"
                  className="px-3.5 py-1.5 rounded-full bg-slate-950 hover:bg-slate-800 border border-slate-700/80 text-cyan-400 text-xs font-extrabold flex items-center gap-1.5 shadow-md transition-all hover:scale-105"
                >
                ...
                <Link
                  to="/transport/login"
                  className="px-3.5 py-1.5 rounded-full bg-slate-950 hover:bg-slate-800 border border-slate-700/80 text-teal-400 text-xs font-extrabold flex items-center gap-1.5 shadow-md transition-all hover:scale-105"
                >
                ...
                <Link
                  ...
                  className="px-3.5 py-1.5 rounded-full bg-slate-950 hover:bg-slate-800 border border-slate-700/80 text-indigo-400 text-xs font-extrabold flex items-center gap-1.5 shadow-md transition-all hover:scale-105"
                >
