...
import { Store, Mail, Lock, ArrowRight, ShoppingBag, Truck, ShieldAlert, Eye, EyeOff } from 'lucide-react';
...
export const SellerLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-900/90 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-[0_0_50px_rgba(245,158,11,0.15)] backdrop-blur-xl text-white">
