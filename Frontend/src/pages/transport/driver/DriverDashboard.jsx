    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col font-sans">
      ...
      {loading ? (
        ...
        <main className="flex-1 p-4 md:p-6 space-y-6 max-w-7xl mx-auto w-full">
          ...
          {/* 4. CURRENT ASSIGNED ORDER (Prominent Card with Bug Fix) */}
          <div className="space-y-3">
            ...
            {currentAssignedOrder ? (
              <div className="bg-slate-900/90 rounded-3xl p-5 md:p-6 border border-cyan-500/40 shadow-2xl space-y-5 backdrop-blur-xl relative overflow-hidden">
                  ...
                  {oldOrdersHistory.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="7" className="p-8 text-center text-slate-400 space-y-1">
                        ...
                        <p className="text-[11px] text-slate-500">Completed and fulfilled scrap delivery orders will appear in this history archive.</p>
                      </td>
                    </tr>
                  )}
                </tbody>
