...
import { Navigation, Truck, Phone, User, MapPin, Clock, ShieldCheck, CheckCircle2, ArrowRight } from 'lucide-react';

export const ManagerLiveTrackingPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-100">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <Navbar title="Fleet Live Visibility & OpenStreetMap Tracking" />
          ...
          <div className="bg-slate-900 text-white rounded-2xl p-6 border border-slate-800 shadow-xl flex items-center justify-between">
            <div>
              <h2 className="text-xl font-extrabold flex items-center gap-2">
                ...
                <span>Live Fleet GPS Tracking Map</span>
              </h2>
              <p className="text-xs text-slate-400 mt-1">Real-time OpenStreetMap tracking for {currentUser?.companyName}. Click any truck marker to view full trip details.</p>
            </div>
            ...
            <div className="lg:col-span-4 bg-white rounded-2xl p-6 border border-slate-200 shadow-xs flex flex-col justify-between space-y-4">
              {selectedTruck ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center p-6 text-slate-500">
                  ...
                  <p className="text-xs font-bold text-slate-700">Select a Truck Marker</p>
                  <p className="text-[11px] text-slate-400 mt-1">Click any truck marker on the map to inspect live driver and route telemetry.</p>
                </div>
              )}
            </div>
          </div>
...
export default ManagerLiveTrackingPage;
